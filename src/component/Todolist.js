...
class Todolist extends Component {
    ...
    handlerFinished = (e)=>{
        console.log('完成');
        this.props.EDITABLE([this.props.index, false, this.changeText]);
        ...
        return (
            <div>
                <ol>
                    ...
                    {
                        this.props.todolist[this.props.index].isEdit === true ? <input type="text" value={this.props.value} onChange={this.changeValue}/> : <span>{this.props.value}</span>
                    }
                    
                    <a href="##" onClick={this.handlerDelete}>删除</a>
                    {
                        this.props.todolist[this.props.index].isEdit === true ? 
